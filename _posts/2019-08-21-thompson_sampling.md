...
$p(\theta \mid x) = \frac{p(x \mid \theta)p(\theta)}{p(x)}$<br>
$= \frac{\binom{n}{k}\theta^{k}(\theta-1)^{n-k}}{\int_{\theta}\binom{n}{k}\theta^{k}{(\theta-1)}^{n-k}d\theta}$<br>
$= \frac{\theta^{k}(\theta-1)^{n-k}}{\frac{\Gamma(x+1)\Gamma(x-k+1)}{\Gamma(x+2)}}$<br>
$= \frac{\Gamma(x+2)}{\Gamma(x+1)\Gamma(x-k+1)}\theta^{k}(\theta-1)^{n-k}$<br>
