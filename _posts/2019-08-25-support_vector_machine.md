...
Linear support vector machine은 $\mathbb{R}^{n}$상에 분포된 data point들과 그것을 가르는 hyperplane 사이의 margin(거리)을 최대화 하는 classification하는 기법이다.

<p align="center"> <img src="https://raw.githubusercontent.com/hanjoonchoe/hanjoonchoe.github.io/master/_posts/images/linear_svm.png" width="100%" height="100%"> <br> 그림 1. linear support vector machine with margin</p>
